...
namespace mStack.API.Bots.Jennifer
{
    ...
    {
        static string _resourceUriSharePoint = System.Environment.GetEnvironmentVariable("SP_TENANT_URL");

        public MainConversationDialog() : base(new LuisService(new LuisModelAttribute(System.Environment.GetEnvironmentVariable("LuisAppId"), System.Environment.GetEnvironmentVariable("LuisAPIKey"))))
    {
        }
