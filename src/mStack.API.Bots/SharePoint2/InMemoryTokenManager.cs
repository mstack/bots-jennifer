...
namespace mStack.API.Bots.SharePoint
{
    ...
    /// </remarks>
    [Serializable]
    public class InMemoryTokenManager : IConsumerTokenManager, IOAuthTokenCache
    {
        ...
        {
            AuthenticationSettings settings = AuthenticationSettings.GetFromAppSettings();

            this.ConsumerKey = settings.ClientId;
            this.ConsumerSecret = settings.ClientSecret;
        }

        public InMemoryTokenManager(byte[] tokenCache)
        {
            AuthenticationSettings settings = AuthenticationSettings.GetFromAppSettings();
        ...
        public void Deserialize(byte[] serialized)
        {
            using (var memStream = new MemoryStream())
            {
                ...
                var obj = (InMemoryTokenManager)binForm.Deserialize(memStream);

                this.tokensAndSecrets = obj.tokensAndSecrets;
